...
export const terms = [
    ...
    {
        title: null,
        text: "Last updated March 25, 2022 These terms and conditions constitute a legally binding agreement (the “Agreement”) between you (also referred to herein as “You”, “Your” or “User”) and Drinking Trees and its affiliates (“we” or “us”), governing your purchase of non-fungible blockchain-based digital token (“NFT”) associated with Drinking Trees and its affiliates and/or any other NFT owned and/or offered by us (the “Purchased NFT”). BY PARTICIPATING IN THIS OFFERING, YOU AGREE TO BE BOUND BY THESE TERMS AND ALL OF THE TERMS INCORPORATED HEREIN AND ALL OF THE TERMS OF SERVICE INCLUDED AS PART OF OZONE NETWORKS, INC D/B/A OPENSEA https://opensea.io/tos (the “OpenSea Terms of Service”). If you do not agree to the terms of this Agreement, as well as the OpenSea Terms of Service, you may not participate in the offering. By entering into this Agreement, and/or by you participating in the Drinking Trees offering, you expressly acknowledge that you understand this Agreement and accept all of its terms. IF YOU DO NOT AGREE TO BE BOUND BY THE TERMS AND CONDITIONS OF THIS AGREEMENT, YOU MAY NOT PARTICIPATE IN THE OFFERING. "
    },


    {
        title: "1. Definitions",
        text: `“Art” means any art, graphics, images, designs, logos, taglines, drawings, or other pictorial or graphic work of authorship that may be associated with Purchased NFT.

        “Drinking Trees” means the Drinking Trees NFT collection and any associated platforms, distribution methods and/or accounts owned and controlled by the project team and/or affiliates.
        ...
        “Name and Likeness” means name, nicknames, images, likenesses, marks, copyrights, trade dress colors, trade dress designs, and/or all other intellectual property of Drinking Trees and its affiliates.  
        ...
        “Purchased NFT” means an NFT that You Own from Drinking Trees and its affiliates.
    ...
    {
        title: "4. Purpose of Purchased NFT",
        text: `(THE PURCHASED NFT IS INTENDED FOR CONSUMER ENJOYMENT, USE AND CONSUMPTION ONLY. IT IS NOT A “SECURITY,” AS DEFINED UNDER THE SECURITIES ACT OF 1933, AS AMENDED, THE SECURITIES EXCHANGE ACT OF 1934, AS AMENDED, THE INVESTMENT COMPANY ACT OF 1940, AS AMENDED, OR UNDER THE SECURITIES LAWS OF ANY U.S. STATE.`
    },
    {
        title: "5. DISCLAIMER OF WARRANTIES & LIMITATION OF LIABILITY",
        text: `ALL PURCHASED NFTs ARE PROVIDED “AS IS” AND “AS AVAILABLE” WITHOUT WARRANTIES OF ANY KIND EITHER EXPRESS OR IMPLIED. TO THE FULLEST EXTENT PERMISSIBLE PURSUANT TO APPLICABLE LAW, DRINKING TREES AND ITS AFFILIATES DISCLAIM ALL WARRANTIES, EXPRESS OR IMPLIED, INCLUDING, BUT NOT LIMITED TO, IMPLIED WARRANTIES OF NON-INFRINGEMENT, MERCHANTABILITY AND FITNESS FOR A PARTICULAR PURPOSE. TO THE FULLEST EXTENT PERMISSIBLE BY APPLICABLE LAW, IN NO EVENT SHALL  DRINKING TREES OR ITS AFFILIATES BE LIABLE TO YOU FOR ANY PERSONAL INJURY, PROPERTY DAMAGE, LOST PROFITS, COST OF SUBSTITUTE GOODS OR SERVICES, LOSS OF DATA, LOSS OF GOODWILL, WORK STOPPAGE, COMPUTER AND/OR DEVICE OR TECHNOLOGY FAILURE OR MALFUNCTION, OR FOR ANY FORM OF DIRECT OR INDIRECT DAMAGES, AND/OR ANY SPECIAL, INCIDENTAL, CONSEQUENTIAL, EXEMPLARY OR PUNITIVE DAMAGES BASED ON ANY CAUSES OF ACTION WHATSOEVER RELATED TO ANY NFT, INCLUDING BUT NOT LIMITED TO THE PURCHASED NFT, THE AUCTION, ANY TECHNOLOGY AND/OR PARTIES RELATED TO THE AUCTION, INCLUDING BUT NOT LIMITED TO BLOCKCHAIN AND/OR OPENSEA. YOU AGREE THAT THIS LIMITATION OF LIABILITY APPLIES WHETHER SUCH ALLEGATIONS ARE FOR BREACH OF CONTRACT, TORTIOUS BEHAVIOR, NEGLIGENCE, OR FALL UNDER ANY OTHER CAUSE OF ACTION, REGARDLESS OF THE BASIS UPON WHICH LIABILITY IS CLAIMED AND EVEN IF A DISCLAIMING PARTY HAS BEEN ADVISED OF THE POSSIBILITY OF SUCH LOSS OR DAMAGE, AND IN ANY EVENT, TO THE MAXIMUM EXTENT PERMITTED BY APPLICABLE LAW, DRINKING TREES AND/OR ITS AFFILIATES TOTAL AGGREGATE LIABILITY SHALL NOT EXCEED TEN PERCENT (10%) OF THE TOTAL SUM PAID DIRECTLY BY YOU TO DRINKING TREES AND/OR ITS AFFILIATES FOR THE APPLICABLE PURCHASED NFT. YOU ACCEPT THE INHERENT SECURITY RISKS OF PROVIDING INFORMATION AND DEALING ONLINE OVER THE INTERNET AND AGREE THAT WE HAVE NO LIABILITY OR RESPONSIBILITY FOR ANY BREACH OF SECURITY UNLESS IT IS DUE TO OUR GROSS NEGLIGENCE. IF APPLICABLE LAW DOES NOT ALLOW ALL OR ANY PART OF THE ABOVE LIMITATION OF LIABILITY TO APPLY TO YOU, THE LIMITATIONS WILL APPLY TO YOU ONLY TO THE EXTENT PERMITTED BY APPLICABLE LAW.`
    },
    {
        title: "6. Assumption Of Risk",
        text: `As noted above, the Purchased NFTs are made available solely for entertainment purposes. You agree that You assume the following risks: (A) To the extent there is a price or market for a blockchain asset such as an NFT, such markets and prices are extremely volatile, and variations in the price of other digital assets could materially and adversely affect the value of any digital asset(s) You own, including Your Purchased NFT, and there is no guarantee that Your Purchased NFTs will have or retain any value; (B) the commercial or market value on a Purchased NFT that You purchase may materially diminish in value as a result of a variety of things such as negative publicity ; (C) there are risks associated with using an Internet-native assets (e.g., non-fungible tokens, cryptocurrencies, etc.) including, but not limited to, the risk of hardware, software and Internet connections and/or failures, the risk of malicious software introduction, and the risk that third parties may obtain unauthorized access to information stored within Your digital “wallet” or elsewhere, and Drinking Trees and its affiliates will not be responsible for any of these, however caused; (D) Drinking Trees and its affiliates does not make any promises or guarantees about the availability of the Purchased NFT, Related Content or the Art on the Internet or that they will host the Purchased NFT or the Related Content and/or Art at any specific location and/or for any specific period of time; (E) upgrades to the blockchain platform(s), a hard fork or other change in the blockchain platform(s), a failure or cessation of blockchain(s), or a change in how transactions are confirmed on the blockchain platform(s) may have unintended, adverse effects on all blockchains using such technologies, including without limitation Purchased NFTs; (F) Drinking Trees and its affiliates do not make any promises or guarantees related to OPENSEA, Blockchain or any other third parties related to this auction and each of their applications and/or services, including but not limited to the continued availability of either and/or the protection and/or storage of any data You provide to those parties; (G) the risk of losing access to Purchased NFT due to loss of private key(s), custodial error or purchaser error; (H) the risk of mining attacks; (I) the risk of hacking, security weaknesses, fraud, counterfeiting, cyber attacks and other technological difficulties (J) the risk of changes to the regulatory regime governing blockchain technologies, cryptocurrencies, and tokens and new regulations, unfavorable regulatory intervention in one or more jurisdictions or policies any of which may materially adversely affect the use and value of the Purchased NFT; (K) the risks related to taxation; (L) that NFTs are not legal tender and are not back by any government; and (M) Drinking Trees and its affiliates are not responsible for any transaction between You and a third party (e.g., Your transfer of a Purchased NFT from a third party on the so-called “secondary market”), and Drinking Trees and its affiliates shall have no liability in connection with any such transaction. In addition to assuming all of the above risks, You acknowledge that You have obtained sufficient information to make an informed decision to license the Purchased NFT and that You understand and agree that You are solely responsible for determining the nature, potential value, suitability and appropriateness of these risks for Yourself. Drinking Trees and its affiliates cannot and do not represent or warrant that any Purchased NFT, or its supporting systems or technology, is reliable, current or error-free, meets Your requirements, or that defects in the Purchased NFT, or its supporting systems or technology, will be corrected. Drinking Trees and its affiliates cannot and do not represent or warrant that the Purchased NFT or the delivery mechanism for it are free of viruses or other harmful components. You accept and acknowledge that Drinking Trees and its affiliates will not be responsible for any communication failures, disruptions, errors, distortions or delays You may experience related to the Auction. `
    },
    {
        title: "7. Governing Law",
        text: `This Agreement and all matters related to it and/or any Purchased NFT shall be governed by, construed, and enforced in accordance with the laws of the Wyoming, as they are applied to agreements entered into and to be performed entirely within Wyoming and without regard to conflict of law principles, except to the extent that law is inconsistent with or preempted by federal law.`
    },
    {
        title: "8. Changes to this Agreement",
        text: `Drinking Trees and/or its affiliates may make changes to this Agreement from time to time. When Drinking Trees and/or its affiliates make such changes, we will make the updated Agreement available on this website and update the “Last Updated” date at the beginning of the Agreement accordingly. Please check this page periodically for changes. Any changes to this Agreement will apply on the date that they are made and, by way of example, Your continued access to or use of the Purchased NFT, the Art and/or Related Content after the Agreement has been updated will constitute Your binding acceptance of the updates. `
    },
    {
        title: "9. Eligibility",
        text: `(a) Participation in the Drinking Trees NFT offering is open only to individuals who have the right and authority to enter into this Agreement, are fully able and competent to satisfy the terms, conditions, and obligations herein and who are using currency that such party is the lawful holder thereof. It is not available to Users who have had their User privileges temporarily or permanently deactivated. You may not allow other persons to use Your User credentials, and You agree that You are the sole authorized user. 

            (b) By becoming a User, You represent and warrant that you have the legal and mental capacity, as well as the legal and mental competence to become a user. 
        
        `
    },
    {
        title: "10. Indemnity",
        text: `You will defend, indemnify, and hold Drinking Trees, including each of its respective affiliates, subsidiaries, parents, successors and assigns, and each of our respective officers, directors, employees, agents, or shareholders, harmless from any claims, actions, suits, losses, costs, liabilities and expenses (including reasonable attorneys’ fees) relating to or arising out of Your license, sale or possession of the Purchased NFT, including without limitation: (1) Your breach of this Agreement or the documents it incorporates by reference; (2) Your violation of any law or the rights of a third party as a result of Your own interaction with such third party; (3) any allegation that any materials that You submit to us or transmit in the course of the auction, communications seeking Drinking Trees’ and its affiliates’ consent to activities or otherwise, infringe or otherwise violate the copyright, trademark, trade secret or other intellectual property or other rights of any third party; and/or (4) any other activities in connection with the offering or the Purchased NFT. This indemnity shall be applicable without regard to the negligence of any party, including any indemnified person. `
    },
    {
        title: "11. Language Translation(s)",
        text: `If You are provided a translation of this Agreement, the original version in English will be used in deciding any issues or disputes which arise under this Agreement. `
    },
    {
        title: "12. Severability",
        text: `If any term or provision of this Agreement is invalid, illegal, or unenforceable in any jurisdiction, such invalidity, illegality, or unenforceability shall not affect any other term or provision of this Agreement or invalidate or render unenforceable such term or provision in any other jurisdiction.`
    }
]